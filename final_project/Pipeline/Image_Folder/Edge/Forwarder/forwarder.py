...
REMOTE_MQTT_HOST = '35.182.93.9' # Jetson IP
REMOTE_MQTT_PORT = 1883 # 1883 - Jetson broker nodeport, 32003 if using Docker
REMOTE_MQTT_TOPIC = "lesion"
# test lines
...
def on_message(client,userdata, msg):
  ...
  try:
    ...
    msg = msg.payload
    remote_mqttclient.publish(REMOTE_MQTT_TOPIC, payload=msg, qos=0, retain=False) # was 0, should set qos to 2
